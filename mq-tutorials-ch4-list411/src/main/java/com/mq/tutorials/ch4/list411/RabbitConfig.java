package com.mq.tutorials.ch4.list411;
...
public class RabbitConfig {
    public static final String WORK_QUEUE_NAME = "work_queue4411";
    public static final String DELAYED_QUEUE_NAME = "delayed_queue4411";
    public static final String WORK_EXCHANGE_NAME = "work_exchange4411";
    public static final String DELAYED_EXCHANGE_NAME = "delayed_exchange4411";
